// Importações das bibliotecas necessárias do Flutter
import 'package:flutter/material.dart';
import 'package:url_strategy/url_strategy.dart';

// Importações de páginas específicas do aplicativo
...
// Função principal
void main() {
  // Configuração da estratégia de URL para suporte a rotas no navegador
  setPathUrlStrategy();
...
class MyApp extends StatelessWidget {
  ...
  // Método de construção da interface do aplicativo
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const HomePage(),
      // Definição de rotas para diferentes páginas do aplicativo
